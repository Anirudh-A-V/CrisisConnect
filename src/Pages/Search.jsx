        ...
        <div>
            ...
            <section className='white h-auto w-full'>
                <div className='flex flex-col justify-start mt-10 items-center h-full w-full'>
                    ...
                    <input type="text" placeholder="Search" className="w-1/2 h-12 mt-4 border-2 border-gray-300 rounded-lg px-4 focus:outline-none focus:border-blue-500" onChange={e => setSearch(e.target.value)} />
                    <button className='bg-blue-400 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded-3xl mt-6 ml-10' onClick={searchHandler} role='button'>
                        Search
                    </button>
                    <div className='flex flex-wrap justify-center items-center mt-10 h-fit w-3/5'>
                        <button className='bg-pink-400 hover:bg-pink-500 text-white font-bold py-2 px-4 rounded-3xl mt-4 ml-10 text-lg' onClick={() => quickSearchHandler('Pregnancy')} role='button'>
                            Pregnancy
                        </button>
                        <button className='bg-pink-400 hover:bg-pink-500 text-white font-bold py-2 px-4 rounded-3xl mt-4 ml-10 text-lg' onClick={() => searchHandler('Accident')} role='button'>
                            Accident
                        </button>
                        <button className='bg-pink-400 hover:bg-pink-500 text-white font-bold py-2 px-4 rounded-3xl mt-4 ml-10 text-lg' onClick={() => searchHandler('Heart Attack')} role='button'>
                            Heart Attack
                        </button>
                        <button className='bg-pink-400 hover:bg-pink-500 text-white font-bold py-2 px-4 rounded-3xl mt-4 ml-10 text-lg' onClick={() => searchHandler('Burns and Scalds')} role='button'>
                            Burns and Scalds
                        </button>
                        <button className='bg-pink-400 hover:bg-pink-500 text-white font-bold py-2 px-4 rounded-3xl mt-4 ml-10 text-lg' onClick={() => searchHandler('Poisoning')} role='button'>
                            Poisoning
                        </button>
            ...
            <section className='results white h-auto w-full'>
                {searchResults.length > 0 &&
                    <div className='flex flex-col justify-start mt-10 items-center h-full w-full'>
                        <h2 className='text-5xl mt-20 ml-10 font-bold text-center text-gray-800'>
